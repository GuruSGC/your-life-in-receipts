...
export default function HomePage() {
  return (
    <DataGate>
      {({ life, story }) => {
        const picks = HIGHLIGHTS.map((id) =>
          story.insights.find((insight) => insight.id === id),
        ).filter((insight) => insight !== undefined)
        return (
          <>
            <PageTitle kicker="Three exports, one person">
            ...
            <p className="-mt-3 mb-6 max-w-2xl text-lg text-ink-2 md:mb-8">
              A listening history, a household ledger and a card statement look unrelated. Laid side
              by side they show chapters, habits and quiet connections. Start with the story, or dig
              through the receipts yourself.
            </p>
            ...
            <section className="paper mt-10 p-5 md:p-6" aria-labelledby="journey-title">
              ...
              <p className="mt-1 max-w-2xl text-ink-2">
                ...
                listening changes level and where a new source of receipts begins. Choose one to
                open it.
              </p>
              <div className="mt-4">
